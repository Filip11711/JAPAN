...
{
    /// <inheritdoc />
    public partial class GenerateAutoKey : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "korisnik",
                columns: new[] { "korisnickoime", "email", "id", "iduloga" },
                values: new object[,]
                {
                    { "admin", "admin@example.com", 1, 1 },
                    { "moderator", "moderator@example.com", 2, 2 },
                    { "korisnik1", "korisnik1@example.com", 3, 3 },
                    { "korisnik2", "korisnik2@example.com", 4, 3 }
                });
